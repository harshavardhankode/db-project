    ...
    <div class="navbar navbar-inverse" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" >
          ...
          <ul class="nav navbar-nav">
            <li><a href="addLaptopInterface.jsp">Laptops</a></li>
            <li><a href="addMobileInterface.jsp">Mobiles</a></li>
            <li class="active"><a href="addTabletInterface.jsp">Tablets</a></li>            
          </ul>
        </div>
      </div>
    </div>
	 ...
	 <div class="container">
	  <form name="loginForm" method="post" action="addTablet.jsp" class="form-signin">
	   <h2 class="form-signin-heading">Adding a tablet</h2>
		...
		<input type="text" name="wifi" class="form-control" placeholder="Wi-Fi" >
		<input type="text" name="three_g" class="form-control" placeholder="3G" >
		<br><p>RAM</p></br>
